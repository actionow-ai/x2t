...
export function EquitySparkline({ points }: { points: { follow: number; spy: number }[] }) {
  ...
  return (
    <svg className="equity" viewBox={`0 0 ${W} ${H}`} width="100%" height={H} preserveAspectRatio="none" role="img" aria-label="equity curve">
